...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: ['Uber', 'Arena Trap', 'Drought', 'Shadow Tag', 'King\'s Rock', 'Razor Fang', 'Soul Dew', 'Assist', 'Swagger'],
	},
	{
		name: "[Gen 4] OU",
		mod: 'gen4',
	...
	},
	{
		...
		banlist: [
			...
			'Zekrom', 'Shadow Tag', 'Soul Dew', 'Baton Pass', 'Swagger',
		],
	},
	{
		...
		onModifyMove(m) {
			if (m.id === 'metronome') {
				m.onHit = function (pokemon) {
					...
					const move = dex.moves.get(randomMove);
					if (move.flags['nonsky']) {
						this.addMove('move', pokemon, move.name, `${null}|[from] move: Metronome`);
